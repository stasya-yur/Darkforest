const wordThemes = {
    forest: {
        ...
        words: [
            ...
            "бук", "клен", "ясен", "дрова", "кора", "багаття", "луна", "узлісся", "хвоя", "жолудь",
            "лісник", "пролісок", "кошик", "хмиз", "кучугура", "чагарник", "хатина", "стежка", "ялиця", "модрина"
        ]
    },
    animals: {
        title: "Тварини",
        words: [
            ...
            "кріт", "ласка", "соловей", "зозуля", "одуд", "лелека", "миша", "пацюк", "вивірка", "хом'як",
            "качка", "гуска", "орел", "яструб", "гриф", "тхорець", "ондатра", "нутрия", "глухар", "тетерів"
        ]
    },
    food: {
        title: "Їжа",
        words: [
            ...
            "яєчня", "ковбаса", "сосиска", "піца", "суп", "суші", "паста", "стейк", "пиріжок", "пончик",
            "сік", "компот", "молоко", "кефір", "йогурт", "масло", "олія", "горіх", "цибуля", "перець"
        ]
    },
    objects: {
        title: "Предмети",
        words: [
            ...
            "ніж", "сокира", "вилка", "чайник", "каструля", "гаманець", "окуляри", "ручка", "лінійка", "флешка",
            "ноутбук", "планшет", "ключі", "газета", "журнал", "гребінець", "дзеркальце", "м'яч", "іграшка", "валіза"
        ]
    },
    places: {
        title: "Місця",
        words: [
            ...
            "teatr", "ринок", "пляж", "гора", "річка", "озеро", "порт", "вокзал", "аеропорт", "стадіон",
            "бібліотека", "лабораторія", "маяк", "сад", "палац", "фортеця", "ферма", "площа", "станція", "водоспад",
            "готель", "ресторан", "кафе", "кінотеатр", "аптека", "лікарня", "банк", "офіс", "завод", "фабрика",
            "супермаркет", "магазин", "церква", "храм", "монастир", "гавань", "каньйон", "пустеля", "долина", "ліс"
        ]
    }
};
